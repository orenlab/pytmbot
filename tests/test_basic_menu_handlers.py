...
type _RawHandlerInput = Callable[..., _MessageHandler | None] | _MessageHandler
...
def test_navigation_start_and_server_handlers(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        navigation_module,
        "em",
        type("_Em", (), {"get_emoji": staticmethod(lambda _name: "e")})(),
    )
    monkeypatch.setattr(
        server_module,
        "em",
        type("_Em2", (), {"get_emoji": staticmethod(lambda _name: "e")})(),
    )
