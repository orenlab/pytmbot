...
class DockerAdapter:
    ...
    def __start_container(self, user_id: int, container_id):
        ...
        try:
            return self.__create_docker_client().containers.get(container_id).start()
        except Exception as e:
    ...
    def __stop_container(self, user_id: int, container_id):
        ...
        try:
            return self.__create_docker_client().containers.get(container_id).stop()
        except Exception as e:
    ...
    def __restart_container(self, user_id: int, container_id):
        ...
        try:
            return self.__create_docker_client().containers.get(container_id).restart()
        except Exception as e:
    ...
    def __rename_container(self, user_id: int, container_id, new_container_name: str):
        ...
        if not self.is_new_name_valid(new_container_name):
            raise ValueError(f"Invalid new container name: {new_container_name}")

        try:
            return self.__create_docker_client().containers.get(container_id).rename(new_container_name)
        except Exception as e:
