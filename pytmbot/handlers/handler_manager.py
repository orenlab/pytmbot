...
from pytmbot.handlers.docker_handlers.inline.container_info import handle_containers_full_info
...
from pytmbot.handlers.docker_handlers.inline.manage_action import handle_manage_container_action, managing_action_fabric
...
def inline_handler_factory():
    ...
    return {
        ...
        'get_logs': [
            HandlerManager(callback=handle_get_logs, func=lambda call: call.data.startswith('__get_logs__'))
        ],
        'containers_full_info': [
            HandlerManager(callback=handle_containers_full_info, func=lambda call: call.data.startswith('__get_full__'))
        ],
        'back_to_containers': [
            HandlerManager(callback=handle_back_to_containers, func=lambda call: call.data == 'back_to_containers')
        ],
        'manage': [
            HandlerManager(callback=handle_manage_container, func=lambda call: call.data.startswith('__manage__'))
        ],
        'manage_action': [
