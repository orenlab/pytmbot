...
def managing_container(user_id: int, container_id: Union[str, int], **kwargs):
    """
    ...
    actions = {
        "start": __start_container,
        "stop": __stop_container,
        "restart": __restart_container,
        "rename": lambda x, y, **z: __rename_container(x, y, new_container_name=z.get("new_container_name"))
    }
...
def __start_container(user_id: int, container_id):
    """
    ...
    """
    if not __user_is_allowed_to_manage_container(user_id):
...
def __stop_container(user_id: int, container_id):
    """
...
def __restart_container(user_id: int, container_id):
    """
...
def __rename_container(user_id: int, container_id, new_container_name: str):
    """
