...
class TestPsutilAdapter(unittest.TestCase):
    ...
    @patch('pytmbot.utils.utilities.set_naturalsize')
    def test_get_disk_usage(self, mock_set_naturalsize, mock_disk_usage, mock_disk_partitions):
        """
    ...
    def test_get_process_counts(self, mock_process_iter):
        ...
        mock_process_iter.return_value = [mock_process, mock_process, mock_process, mock_process]
