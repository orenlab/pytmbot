...
class ContainerManager:
    ...
    @validate_access
    def __start_container(self, user_id: int, container_id: ContainerId) -> DockerResponse:
        """Starts a Docker container with access validation."""
        try:
            container = self.__get_container(container_id)
            logger.info("Starting container", extra={"container_id": container_id, "user_id": user_id})
    ...
    @validate_access
    def __stop_container(self, user_id: int, container_id: ContainerId) -> DockerResponse:
        """Stops a Docker container with access validation."""
        try:
            container = self.__get_container(container_id)
            logger.info("Stopping container", extra={"container_id": container_id, "user_id": user_id})
    ...
    @validate_access
    def __restart_container(self, user_id: int, container_id: ContainerId) -> DockerResponse:
        """Restarts a Docker container with access validation."""
        try:
            container = self.__get_container(container_id)
            logger.info("Restarting container", extra={"container_id": container_id, "user_id": user_id})
